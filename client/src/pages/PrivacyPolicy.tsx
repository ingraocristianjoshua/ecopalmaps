...
const PrivacyPolicyContent = styled(PageText)`
...
function PrivacyPolicy() {
    return (
        <>
            <Head
                title="Privacy policy | EcoPalMaps"
                description="La privacy policy relativa a questa piattaforma."
            />
            <PageLayout
                content={
                    <PageContent>
                        ...
                        <PageDescription>
                            Questa è la privacy policy relativa alla piattaforma
                            EcoPalMaps, in conformità alle leggi in vigore sul
                        ...
                        <PrivacyPolicyContent>
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>
                                        ...
                                        companies or individuals employed by the
                                        Company to facilitate the Service, to
                                        provide the Service on behalf of the
                                        Company, to perform services related to
                                ...
                                <li>
                                    <p>
                                        <strong>Usage Data</strong> refers to
                                        data collected automatically, either
                                ...
                                <li>
                                    <p>
                                        ...
                                        EcoPalMaps, accessible from{" "}
                                        <a
                                            href="https://ecopalmaps.com"
                                            rel="external nofollow noopener"
                                            target="_blank"
                                        >
                                            https://ecopalmaps.com
                                        </a>
                                    </p>
                                </li>
                                <li>
                            ...
                            <p>
                                ...
                                remain on Your personal computer or mobile
                                device when You go offline, while Session
                                Cookies are deleted as soon as You close Your
                                web browser.
                            </p>
                            <p>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>
                                        ...
                                        these Cookies, the services that You
                                        have asked for cannot be provided, and
                                        We only use these Cookies to provide You
                                        with those services.
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>
                                        ...
                                        re-enter your preferences every time You
                                        use the Website.
                                    </p>
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>
                                        ...
                                        the Service. The Personal Data You
                                ...
                                <li>
                                    <p>
                                        ...
                                        news, special offers and general
                                        information about other goods, services
                                        and events which we offer that are
                                        similar to those that you have already
                                        purchased or enquired about unless You
                                        have opted not to receive such
                                        information.
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p>
                                        ...
                                        We may use Your information to evaluate
                                        or conduct a merger, divestiture,
                                        restructuring, reorganization,
                                        dissolution, or other sale or transfer
                                        of some or all of Our assets, whether as
                                        a going concern or as part of
                                        bankruptcy, liquidation, or similar
                                        proceeding, in which Personal Data held
                                        by Us about our Service users is among
                            ...
                            <ul>
                                <li>
                                    <p>By email: info@ecopalmaps.com</p>
                                </li>
                                <li>
                                    <p>
                                        By visiting this{" "}
                                        <a
                                            href="https://ecopalmaps.com/support"
                                            rel="external nofollow noopener"
                                            target="_blank"
                                        >
                                            page
